...
namespace Zebble
{
    partial class zebbleOxyPlot
    {
        ...
        public abstract class UIElement : SelectableElement
        {
            ...
            /// </summary>
            /// <param name="ee">The <see cref="OxyMouseEventArgs" /> instance containing the event data.</param>
            protected internal virtual void OnMouseDown(OxyMouseDownEventArgs ee)
            {
