...
namespace Zebble
{
    partial class zebbleOxyPlot
    {
        ...
        public class DateTimeAxis : LinearAxis
        {
            ...
            public static DataPoint CreateDataPoint(DateTime xx, double yy)
            {
                return new DataPoint(ToDouble(xx), yy);
            }
            ...
            /// <param name="y">The y value.</param>
            /// <returns>A data point.</returns>
            public static DataPoint CreateDataPoint(DateTime xx, DateTime yy)
            {
                return new DataPoint(ToDouble(xx), ToDouble(yy));
            }
            ...
            /// <param name="y">The y value.</param>
            /// <returns>A data point.</returns>
            public static DataPoint CreateDataPoint(double xx, DateTime yy)
            {
                return new DataPoint(xx, ToDouble(yy));
            }
            ...
            public override object GetValue(double xx)
            {
                var time = ToDateTime(xx);
            ...
            protected override string FormatValueOverride(double xx)
            {
            ...
            protected override double CalculateActualInterval(double availableSize, double maxIntervalSize)
            {
                ...
                var range = Math.Abs(this.ActualMinimum - this.ActualMaximum);
