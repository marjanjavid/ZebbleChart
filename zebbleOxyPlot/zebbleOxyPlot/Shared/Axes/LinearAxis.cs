    ...
    partial class zebbleOxyPlot
    {
        ...
        public class LinearAxis : Axis
        {
            ...
            protected override string FormatValueOverride(double xx)
            {
                ...
                {
                    return FractionHelper.ConvertToFractionString(xx, this.FractionUnit, this.FractionUnitSymbol, 1e-6, this.ActualCulture, this.StringFormat);
                }

                return base.FormatValueOverride(xx);
            }
        }
    }
}