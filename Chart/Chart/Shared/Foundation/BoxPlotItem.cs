   ...
   public partial class Chart
    {
        ...
        public class BoxPlotItem
        {
            ...
            public static implicit operator OxyPlot.Series.BoxPlotItem(BoxPlotItem datapoint)
            {
                var oxyplotdatapoint = new OxyPlot.Series.BoxPlotItem(datapoint.X, datapoint.LowerWhisker,datapoint.BoxBottom,datapoint.Median,datapoint.BoxTop,datapoint.UpperWhisker);
